...
part.Destroy(part)
			...
			until (P.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 100 and game.Players.LocalPlayer.Character.Humanoid.Health > 0
		end)
		...
		local MyLevel = game.Players.LocalPlayer.Data.Level.Value
			...
			if ThreeWorld then
				...
				elseif MyLevel >= 2275 and MyLevel<=2299 then 
					...
					CFrameQuest = CFrame.new(230.672729, 24.7600384, -12198.6787, 0.0864662081, -3.57646286e-08, 0.996254802, -1.19936757e-07, 1, 4.63085392e-08, -0.996254802, -1.23491688e-07, 0.0864662081)
					CFrameMon = CFrame.new(113.095558, 24.76017, -12222.2588, -0.205096737, -0, -0.978741765, -0, 1.00000012, -0, 0.978741765, 0, -0.205096737)
					...
					CFrameQuest = CFrame.new(230.672729, 24.7600384, -12198.6787, 0.0864662081, -3.57646286e-08, 0.996254802, -1.19936757e-07, 1, 4.63085392e-08, -0.996254802, -1.23491688e-07, 0.0864662081)
					CFrameMon = CFrame.new(692.89856, 24.7601948, -12636.0908, 0.538462341, 1.97431351e-08, -0.842649579, -9.54910995e-09, 1, 1.73278423e-08, 0.842649579, -1.28383693e-09, 0.538462341)
							elseif MyLevel >= 2350 and MyLevel<=2374 then 
					Ms = "Sweet Thief [Lv. 2350]"
					NameQuest = "ChocQuest2"
					LevelQuest = 1
					NameMon = "Sweet Thief"
					CFrameQuest = CFrame.new(150.149414, 24.819622, -12771.4277, 0.470252186, -2.10301021e-08, 0.88253206, 2.87148101e-08, 1, 8.52875548e-09, -0.88253206, 2.13310756e-08, 0.470252186)
					CFrameMon = CFrame.new(-20.0258827, 24.8197575, -12634.4326, -0.849365354, -2.7608861e-08, -0.527805388, -2.61844342e-08, 1, -1.01717612e-08, 0.527805388, 5.18074383e-09, -0.849365354)
					...
					NameMon = "Candy Rebel"
					CFrameQuest = CFrame.new(150.149414, 24.819622, -12771.4277, 0.470252186, -2.10301021e-08, 0.88253206, 2.87148101e-08, 1, 8.52875548e-09, -0.88253206, 2.13310756e-08, 0.470252186)
					CFrameMon = CFrame.new(98.1978378, 24.8196487, -12900.0508, 0.526558936, 1.68818879e-08, 0.850138605, -1.16490426e-08, 1, -1.26426212e-08, -0.850138605, -3.24621596e-09, 0.526558936)
			elseif MyLevel >= 2400 and MyLevel<=2424 then 
					Ms = "Candy Pirate [Lv. 2400]"
					NameQuest = "CandyQuest1"
					LevelQuest = 1
					NameMon = "Candy Rebel"
					CFrameQuest = CFrame.new(-1262.83508, 14.1289549, -14484.8926, 0.656263351, 0, -0.75453198, -0, 1.00000012, -0, 0.75453198, 0, 0.656263351)
					CFrameMon = CFrame.new(-1285.84497, 14.8212357, -14438.2764, -0.269966513, -5.61459039e-08, 0.962869704, -3.71530078e-08, 1, 4.78941615e-08, -0.962869704, -2.28436878e-08, -0.269966513)
				...
				elseif MyLevel >= 2425 then 
					...
					NameMon = "Snow Demon"
					CFrameQuest = CFrame.new(-1262.83508, 14.1289549, -14484.8926, 0.656263351, 0, -0.75453198, -0, 1.00000012, -0, 0.75453198, 0, 0.656263351)
					CFrameMon = CFrame.new(-925.529419, 14.8213062, -14388.7793, 0.97269249, 1.67055247e-09, -0.232097775, 4.23684599e-09, 1, 2.49537102e-08, 0.232097775, -2.52556482e-08, 0.97269249)
		    ...
		    if OldWorld then
				...
				elseif MyLevel == 400 or MyLevel <= 449 then -- Fishman Commando
					...
					NameMon = "Fishman Commando"
					CFrameQuest = CFrame.new(61122.5625, 18.4716396, 1568.16504, 0.893533468, 3.95251609e-09, 0.448996574, -2.34327455e-08, 1, 3.78297464e-08, -0.448996574, -4.43233645e-08, 0.893533468)
					CFrameMon = CFrame.new(61890.5195, 18.48283, 1475.2229, 0.604474187, 1.35142002e-07, -0.79662472, -5.68487266e-08, 1, 1.26506762e-07, 0.79662472, -3.11829673e-08, 0.604474187)
				elseif MyLevel == 450 or MyLevel <= 474 then 
					Nonquest = false
					Ms = "God's Guard [Lv. 450]"
					NameQuest = "SkyExp1Quest"
						...
						elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true  then
							...
							if game:GetService("Workspace").Enemies:FindFirstChild(Ms) then
								for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
									if bai.autofram and v.Name == Ms and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
							...
							elseif NewWorld and not string.find(Ms, "Ship") and (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 30000 then
								...
								game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-6508.5581054688, 89.034996032715, -132.83953857422))
											...
											until (not bai.autofram or not v.Parent or v.Humanoid.Health <= 0) or (not string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) ) or (game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false )
                                        ...
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                         ...
                                         if (v.HumanoidRootPart.Position -game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <50 then
                                                                ...
                                                                elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild("Human-Human: Buddha") then
                                                                    if bai.z and v.Humanoid.Health > 0 and game.Players.LocalPlayer.Character.HumanoidRootPart.Size == Vector3.new(7.6, 7.676, 3.686) then
                                                                    else
                                                                        game:service('VirtualInputManager'):SendKeyEvent(true, "Z", false, game)
                                                                        wait(.1)
                                                                        game:service('VirtualInputManager'):SendKeyEvent(false, "Z", false, game)
 ...
 if bai.autofram==true or bai.autosjiguoshi==true then
	...
	if OldWorld then
		...
		Island = {
			...
			["九头蛇岛"] = CFrame.new(3399.32227, 72.4142914, 1572.99963, -0.809679806, -4.48284467e-08, 0.586871922, 2.42332163e-08, 1, 1.09818842e-07, -0.586871922, 1.0313989e-07, -0.809679806),
...
local Tab2 = win:Tab("加点功能", "15613380753")
local Tab3 = win:Tab("其他功能", "15613380753")
local Tab4 = win:Tab("设置", "15613380753")
