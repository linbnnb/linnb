       if not game:IsLoaded() then
        ...
        game:GetService("Players").LocalPlayer.PlayerGui.Money.Container.premium.TextLabel.Text = "林 User"
        game:GetService("Players").LocalPlayer.PlayerGui.Money.Container["2x cash"].Visible = true
        game:GetService("Players").LocalPlayer.PlayerGui.Money.Container["2x cash"].TextLabel.Text = "林 By Smk"
        ...
        game:GetService("Workspace").OhioSign.Screen.SurfaceGui.Frame.Population.Text = "林P User"
